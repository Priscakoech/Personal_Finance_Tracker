    ...
    MDBoxLayout:
        ...
        MDCard:
            ...
            MDBoxLayout:
                ...
                CustomLabel:
                    text: "[size=18dp]Privacy Policy[/size]"
                    bold: True
                    halign: "left"
...
class PrivacyPolicyScreen(MDScreen):
    chunk1, chunk2, chunk3, chunk4, chunk5 = StringProperty(""), StringProperty(""), StringProperty(""), StringProperty(""), StringProperty("")

    def on_pre_enter(self, *args):
        with open("assets/pft_privacy_policy.txt", "r", encoding="utf-8") as file:
        ...
        self.chunk4 = MarkdownFormatter().format_text("".join(chunks[3]))
        self.chunk5 = MarkdownFormatter().format_text("".join(chunks[4]))

    def on_pre_leave(self):
        self.ids.privacy_policy_scroll.scroll_y = 1
